...
export const metadata: Metadata = {
  title: 'Accessing the Open Source Files — Lesson Hollow Help',
  description:
...
export default function AccessingOpenSourceFilesPage() {
  return (
    <>
      <hgroup>
        <h1>Accessing the Open Source Files</h1>
        <p>
          Lesson Hollow is open source. You can read the same files that power
          the product on GitHub and use them as examples or uploadable CSVs.
        </p>
      </hgroup>
